...
function Cloudinary(props) {
    ...
    const pictureUpload=(event)=> {
       ...
       Axios.post(
           "https://api.cloudinary.com/v1_1/"+process.env.NEXT_PUBLIC_CLOUDNAME+"/auto/upload",
           formData
       )
       .then(response=>{
        setImageSelected("");
        ...
        }else if (response.data.url.match(/\.(avi|mov|mp4|wmv|webm|mpg|mp2|mpeg|mpe|mpv|ogg|m4p|m4v)$/) != null){
        ...
        .catch(e=>{console.log('Fail to upload. (check file size limit!')})
    }
    ...
    return(
      ...
      <br />
            ...
            <Button onClick={(e)=>{pictureUpload(e)}}>Attach file</Button>
    
          <br />
          <br />
    {imageSelected!=='' && <img src={imageSelected} width="200" height="200" alt="" />}
    {videoSelected!=='' && <video width="200" height="200" >
